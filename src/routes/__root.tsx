...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "NexusCrafters — Websites, Discord Bots & Servers" },
      {
        name: "description",
        content:
          "Custom websites, Discord bots and professional Discord servers built to your requirements.",
      },
      { property: "og:title", content: "NexusCrafters" },
      {
        property: "og:description",
        content: "Custom websites, Discord bots and professional Discord servers.",
      },
